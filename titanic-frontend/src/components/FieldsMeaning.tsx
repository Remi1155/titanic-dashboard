...
const FieldsMeaning: React.FC = () => {
  const fields = [
    ...
    { label: 'SibSp', description: 'Nombre de frères et sœurs ou conjoints présents à bord.', bgColor: '#3a402a', icon: 'fa-users' },
    { label: 'Parch', description: 'Nombre de parents ou d’enfants présents à bord.', bgColor: '#2a403a', icon: 'fa-child' },
  ...
  return (
    <div>
      <h2>Champs dans les données et ses signification:</h2>
